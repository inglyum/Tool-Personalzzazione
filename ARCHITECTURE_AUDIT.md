...
| Misura | Valore | Dove |
|---|---:|---|
| Override / monkey patch | **211** | riassegnazioni di funzioni già definite altrove |
| Funzioni con lo stesso nome in più file | **146** | |
| Funzioni `render*` con lo stesso nome | **44** | `render` in 90 file, `renderSection` in 35 |
| API globali dichiarate | **396** | 9 dichiarate in più file |
| `onclick` in linea | **2.001** | |
| `addEventListener` | **420** | |
| `setInterval` | **92** | in 48 file |
| `MutationObserver` | **21** | in 19 file |
| Sezioni (`view-*`) | **95** | |
| Chiavi localStorage | **118** | 26 scritte da più file |
| Store IndexedDB | **32** | 9 scritti da più file |
| **`catch {}` vuoti** | **532** | in 126 file |
| Calcoli letti dal DOM | **225** | in 42 file |
| `!important` | **308** | in 43 file |
| Selettori CSS ripetuti in più fogli | **66** | |
| Emoji in stringhe di interfaccia | **6.417** | in 136 file |
...
## A2 · 532 `catch {}` vuoti — il software mente sui salvataggi

**Problema.** 532 blocchi `catch` vuoti in 126 file. Un salvataggio fallito non
...
## A5 · 225 calcoli letti dal DOM

**Problema.** 225 punti calcolano leggendo valori dagli elementi della pagina:
...
## A8 · 308 `!important` e 66 selettori ripetuti

**Problema.** 308 dichiarazioni `!important` in 43 file; 66 selettori CSS
...
## A9 · 2.001 `onclick` in linea

**Problema.** 2.001 gestori scritti negli attributi HTML.
...
## A10 · 92 `setInterval` e 21 `MutationObserver`

**Problema.** 92 timer ripetuti in 48 file (17 nella sola patch 117), 21
...
## A11 · 6.417 emoji nelle interfacce operative

**Problema.** 6.417 emoji in stringhe di interfaccia, in 136 file.
...
**Problema.** 396 simboli globali; 9 dichiarati in più file
